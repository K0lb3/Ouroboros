...
namespace UpsightMiniJSON
{
  public static class Json
  {
    ...
    public static List<object> ToJsonArray(string json)
    {
      return Json.Deserialize(json) as List<object>;
    }

    public static Dictionary<string, object> ToJsonObject(string json)
    {
                ...
                default:
                  switch (peekChar)
                  {
                    ...
                    default:
                      ...
                      if (nextWord != null)
                      {
                        if (Json.Parser.\u003C\u003Ef__switch\u0024map12 == null)
                          Json.Parser.\u003C\u003Ef__switch\u0024map12 = new Dictionary<string, int>(3)
                          {
                            {
                              "false",
                              0
                        ...
                        int num;
                        if (Json.Parser.\u003C\u003Ef__switch\u0024map12.TryGetValue(nextWord, out num))
                        {
                          switch (num)
                          {
                            case 0:
