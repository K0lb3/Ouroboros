  ...
  public class ChatTemplateMessage : MonoBehaviour
  {
    ...
    private void SetupButtons()
    {
      ...
      for (int index2 = num1; index2 <= num2; ++index2)
      {
        ...
        ChatTemplateMessage.\u003CSetupButtons\u003Ec__AnonStorey316 buttonsCAnonStorey316 = new ChatTemplateMessage.\u003CSetupButtons\u003Ec__AnonStorey316();
        // ISSUE: reference to a compiler-generated field
        buttonsCAnonStorey316.\u003C\u003Ef__this = this;
        ...
        if (this.prefs_data.messages[index2] != null && !Object.op_Equality((Object) this.template_message_buttons[index1], (Object) null))
        {
          ...
          // ISSUE: reference to a compiler-generated field
          buttonsCAnonStorey316.msg_index = index2;
          // ISSUE: method pointer
          ((UnityEvent) this.template_message_buttons[index1].get_onClick()).AddListener(new UnityAction((object) buttonsCAnonStorey316, __methodptr(\u003C\u003Em__32F)));
          ++index1;
        }
      }
    }
    ...
    {
      // ISSUE: method pointer
      ((UnityEvent) this.next_page_button.get_onClick()).AddListener(new UnityAction((object) this, __methodptr(\u003CSetupPageButton\u003Em__330)));
      // ISSUE: method pointer
      ((UnityEvent) this.back_page_button.get_onClick()).AddListener(new UnityAction((object) this, __methodptr(\u003CSetupPageButton\u003Em__331)));
    }
