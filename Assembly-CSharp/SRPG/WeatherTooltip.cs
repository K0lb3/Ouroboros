...
namespace SRPG
{
  public class WeatherTooltip : MonoBehaviour
  {
    ...
    private void ShowTooltip(PointerEventData event_data)
    {
      ...
      if (!Object.op_Inequality((Object) this.mTooltip.TooltipText, (Object) null) || dataOfClass == null)
        return;
      this.mTooltip.TooltipText.set_text(string.Format(LocalizedText.Get("quest.WEATHER_DESC"), (object) dataOfClass.Name, (object) dataOfClass.Expr));
    ...
    private IEnumerator ResetPosiotion()
    {
      ...
      return (IEnumerator) new WeatherTooltip.\u003CResetPosiotion\u003Ec__Iterator53() { \u003C\u003Ef__this = this };
    }
