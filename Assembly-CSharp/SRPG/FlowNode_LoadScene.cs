...
namespace SRPG
{
  ...
  public class FlowNode_LoadScene : FlowNode
  {
    ...
    private IEnumerator PreLoadSceneAsync(string sceneName)
    {
      ...
      return (IEnumerator) new FlowNode_LoadScene.\u003CPreLoadSceneAsync\u003Ec__Iterator86() { sceneName = sceneName, \u003C\u0024\u003EsceneName = sceneName, \u003C\u003Ef__this = this };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new FlowNode_LoadScene.\u003CLoadLevelAsync\u003Ec__Iterator87() { \u003C\u003Ef__this = this };
    }
