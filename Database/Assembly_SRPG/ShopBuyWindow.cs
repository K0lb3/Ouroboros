  ...
  public class ShopBuyWindow : MonoBehaviour, IFlowInterface
  {
    ...
    private void Refresh()
    {
      ...
      for (int index = 0; index < count; ++index)
      {
        ...
        ((ShopBuyList) mBuyItem.GetComponentInChildren<ShopBuyList>()).ShopItem = data1;
    ...
    private void OnSelect(GameObject go)
    {
      ...
      ShopBuyList component = (ShopBuyList) this.mBuyItems[GlobalVars.ShopBuyIndex].GetComponent<ShopBuyList>();
