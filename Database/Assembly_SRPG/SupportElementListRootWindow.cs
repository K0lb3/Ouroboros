...
namespace SRPG
{
  public class SupportElementListRootWindow : MonoBehaviour
  {
    ...
    public void OnEvent(string key, string value)
    {
      ...
      if (SupportElementListRootWindow.\u003C\u003Ef__switch\u0024map1A == null)
      {
        // ISSUE: reference to a compiler-generated field
        SupportElementListRootWindow.\u003C\u003Ef__switch\u0024map1A = new Dictionary<string, int>(3)
        {
          {
            "SET",
            0
      ...
      int num;
      // ISSUE: reference to a compiler-generated field
      if (!SupportElementListRootWindow.\u003C\u003Ef__switch\u0024map1A.TryGetValue(key1, out num))
        return;
      switch (num)
      {
        case 0:
