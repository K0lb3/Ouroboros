namespace SRPG
{
    ...
    [EventActionInfo("アクター/表示切替", "シーン上のアクターの表示状態を切り替えます", 0x555555, 0x444488)]
    public class EventAction_ToggleActor : EventAction
    {
        ...
        {
            <PreloadAssets>c__Iterator9B iteratorb;
            iteratorb = new <PreloadAssets>c__Iterator9B();
        ...
        [CompilerGenerated]
        private sealed class <PreloadAssets>c__Iterator9B : IEnumerator, IDisposable, IEnumerator<object>
        {
            internal LoadRequest <req>__0;
            internal int $PC;
            internal object $current;
            internal EventAction_ToggleActor <>f__this;

            public <PreloadAssets>c__Iterator9B()
            {
                base..ctor();
                return;
            }
