...
namespace SRPG
{
  ...
  public class FlowNode_MultiTowerDownload : FlowNode
  {
    ...
    private IEnumerator DownloadFloorParamAsync()
    {
      ...
      return (IEnumerator) new FlowNode_MultiTowerDownload.\u003CDownloadFloorParamAsync\u003Ec__IteratorCB() { \u003C\u003Ef__this = this };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new FlowNode_MultiTowerDownload.\u003CRequestDownloadFloors\u003Ec__IteratorCC() { floorParams = floorParams, \u003C\u0024\u003EfloorParams = floorParams, \u003C\u003Ef__this = this };
    }
