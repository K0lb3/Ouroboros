namespace SRPG
{
    ...
    public class RankMatchClassList : SRPG_ListBase
    {
        ...
        protected override void Start()
        {
            ...
            <Start>c__AnonStorey390 storey;
            storey = new <Start>c__AnonStorey390();
            storey.<>f__this = this;
            base.Start();
        ...
        Label_013D:
            ...
            storey.gm.GetVersusRankClassList(storey.gm.RankMatchScheduleId).ForEach(new Action<VersusRankClassParam>(storey.<>m__3E2));
            return;
        }

        [CompilerGenerated]
        private sealed class <Start>c__AnonStorey390
        {
            internal GameManager gm;
            internal RankMatchClassList <>f__this;

            public <Start>c__AnonStorey390()
            {
                base..ctor();
                return;
            }

            internal void <>m__3E2(VersusRankClassParam vrc)
            {
                List<VersusRankReward> list;
                <Start>c__AnonStorey391 storey;
                storey = new <Start>c__AnonStorey391();
                storey.<>f__ref$912 = this;
                storey.item = Object.Instantiate<RankMatchClassListItem>(this.<>f__this.ListItem);
                DataSource.Bind<VersusRankClassParam>(storey.item.get_gameObject(), vrc);
                ...
                this.gm.GetVersusRankClassRewardList(vrc.RewardId).ForEach(new Action<VersusRankReward>(storey.<>m__3E3));
                return;
            }

            private sealed class <Start>c__AnonStorey391
            {
                internal RankMatchClassListItem item;
                internal RankMatchClassList.<Start>c__AnonStorey390 <>f__ref$912;

                public <Start>c__AnonStorey391()
                {
                    base..ctor();
                    return;
                }

                internal unsafe void <>m__3E3(VersusRankReward reward)
                {
                    GameObject obj2;
                    bool flag;
                    UnitParam param;
                    ...
                    goto Label_0159;
                Label_0030:
                    param = this.<>f__ref$912.gm.GetUnitParam(reward.IName);
                    if (param != null)
                    {
                        goto Label_004E;
                    }
                ...
                Label_004E:
                    ...
                    goto Label_015A;
                Label_006B:
                    param2 = this.<>f__ref$912.gm.GetItemParam(reward.IName);
                    if (param2 != null)
                    {
                        goto Label_0089;
                    }
                ...
                Label_00C0:
                    ...
                    goto Label_015A;
                Label_00D8:
                    param3 = this.<>f__ref$912.gm.GetAwardParam(reward.IName);
                    if (param3 != null)
                    {
                        goto Label_00F8;
                    }
                ...
                Label_00F8:
                    ...
                    goto Label_015A;
                Label_0116:
                    param4 = this.<>f__ref$912.gm.MasterParam.GetArtifactParam(reward.IName);
                    if (param4 != null)
                    {
                        goto Label_013B;
                    }
