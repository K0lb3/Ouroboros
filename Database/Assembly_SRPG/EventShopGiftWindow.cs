namespace SRPG
{
    ...
    public class EventShopGiftWindow : MonoBehaviour
    {
        ...
        private void Refresh()
        {
            ...
            ItemData data3;
            EventShopGiftItem item2;
            <Refresh>c__AnonStorey339 storey;
            storey = new <Refresh>c__AnonStorey339();
        ...
        Label_0056:
            ...
            item = Enumerable.FirstOrDefault<EventShopItem>(data.items, new Func<EventShopItem, bool>(storey.<>m__312));
        ...
        Label_024A:
            item2 = obj2.GetComponent<EventShopGiftItem>();
            if ((item2 != null) == null)
            {
                goto Label_0270;
            }
        ...
        [CompilerGenerated]
        private sealed class <Refresh>c__AnonStorey339
        {
            internal int shopdata_index;

            public <Refresh>c__AnonStorey339()
            {
                base..ctor();
                return;
            }

            internal bool <>m__312(EventShopItem item)
            {
