namespace SRPG
{
    ...
    public class LimitedShopBuyList : MonoBehaviour
    {
        ...
        private unsafe void Refresh()
        {
            ...
            Color color;
            string str;
            if (this.mLimitedShopItem.is_soldout == null)
            {
                goto Label_002E;
            }
        ...
        Label_0059:
            ...
            time3 = TimeManager.FromUnixTime(GlobalVars.LimitedShopItem.shops.end);
            if ((time2 > time3) == null)
            {
                goto Label_00AA;
            }
        ...
        public LimitedShopItem limitedShopItem
        {
            ...
            set
            {
                ...
                GameUtility.SetGameObjectActive(this.limit, this.mLimitedShopItem.is_reset == 0);
                GameUtility.SetGameObjectActive(this.icon_set, this.mLimitedShopItem.saleType == 7);
                GameUtility.SetGameObjectActive(this.sold_count, this.limitedShopItem.IsNotLimited == 0);
                GameUtility.SetGameObjectActive(this.no_limited_price, this.limitedShopItem.IsNotLimited);
                if (this.limitedShopItem.IsItem != null)
                {
                    goto Label_009E;
                }
                if (this.limitedShopItem.IsSet == null)
                {
                    goto Label_00EB;
                }
            Label_009E:
                ...
                goto Label_01A0;
            Label_00EB:
                if (this.limitedShopItem.IsArtifact == null)
                {
                    goto Label_0148;
                }
                ...
                goto Label_01A0;
            Label_0148:
                if (this.limitedShopItem.IsConceptCard == null)
                {
                    goto Label_01A0;
                }
                GameUtility.SetGameObjectActive(this.item_name, 0);
