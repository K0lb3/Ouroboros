namespace SRPG
{
    ...
    [EventActionInfo("会話/表示", "会話の文章を表示し、プレイヤーの入力を待ちます。", 0x555588, 0x5555aa)]
    public class EventAction_Dialog : EventAction
    {
        ...
        {
            <PreloadAssets>c__Iterator88 iterator;
            iterator = new <PreloadAssets>c__Iterator88();
        ...
        [CompilerGenerated]
        private sealed class <PreloadAssets>c__Iterator88 : IEnumerator, IDisposable, IEnumerator<object>
        {
            internal int $PC;
            internal object $current;
            internal EventAction_Dialog <>f__this;

            public <PreloadAssets>c__Iterator88()
            {
                base..ctor();
                return;
            }
            ...
            public bool MoveNext()
            {
                ...
                goto Label_01BF;
            Label_0025:
                this.<>f__this.mBubbleResource = AssetManager.LoadAsync<EventDialogBubble>(EventAction_Dialog.AssetPath);
            ...
            Label_0077:
                ...
                Debug.LogError("Failed to load " + EventAction_Dialog.AssetPath);
