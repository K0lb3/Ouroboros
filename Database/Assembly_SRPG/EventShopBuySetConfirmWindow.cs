namespace SRPG
{
    ...
    [Pin(10, "Slider Plus", 0, 10), Pin(11, "Slider Minus", 0, 11), Pin(1, "Refresh", 0, 1), Pin(100, "武具詳細情報セット(in)", 0, 100), Pin(0x65, "武具詳細情報セット(out)", 1, 0x65)]
    public class EventShopBuySetConfirmWindow : MonoBehaviour, IFlowInterface
    {
        ...
        [CompilerGenerated]
        private static Func<EventShopItem, bool> <>f__am$cache22;

        public EventShopBuySetConfirmWindow()
        {
            this.event_shop_item_set_list = new List<EventShopSetItemListElement>();
        ...
        [CompilerGenerated]
        private static bool <Refresh>m__309(EventShopItem item)
        {
        ...
        private unsafe void Refresh()
        {
            ...
            GameObject obj2;
            Vector3 vector;
            EventShopSetItemListElement element;
            ...
            <>f__am$cache22 = new Func<EventShopItem, bool>(EventShopBuySetConfirmWindow.<Refresh>m__309);
        Label_002F:
            this.mShopitem = Enumerable.FirstOrDefault<EventShopItem>(data.items, <>f__am$cache22);
        ...
        Label_02FC:
            obj2 = null;
            if (num2 >= this.event_shop_item_set_list.Count)
            {
                goto Label_032A;
            }
            obj2 = this.event_shop_item_set_list[num2].get_gameObject();
            goto Label_0337;
        Label_032A:
        ...
        Label_0337:
            ...
            element = obj2.GetComponent<EventShopSetItemListElement>();
        ...
        Label_04A5:
            ...
            this.event_shop_item_set_list.Add(element);
        Label_0507:
            num2 += 1;
        Label_050D:
