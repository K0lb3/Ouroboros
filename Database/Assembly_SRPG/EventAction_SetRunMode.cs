namespace SRPG
{
    ...
    [EventActionInfo("アクター/走りアニメーション変更", "ユニットの走りアニメーションを変更します。", 0x555555, 0x444488)]
    public class EventAction_SetRunMode : EventAction
    {
        ...
        {
            <PreloadAssets>c__Iterator91 iterator;
            iterator = new <PreloadAssets>c__Iterator91();
        ...
        [CompilerGenerated]
        private sealed class <PreloadAssets>c__Iterator91 : IEnumerator, IDisposable, IEnumerator<object>
        {
            internal GameObject <go>__0;
            internal TacticsUnitController <controller>__1;
            internal int $PC;
            internal object $current;
            internal EventAction_SetRunMode <>f__this;

            public <PreloadAssets>c__Iterator91()
            {
                base..ctor();
                return;
            }
