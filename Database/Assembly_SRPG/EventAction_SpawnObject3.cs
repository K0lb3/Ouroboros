namespace SRPG
{
    ...
    [EventActionInfo("New/オブジェクト/配置2", "シーンにオブジェクトを配置します。", 0x445555, 0x448888)]
    public class EventAction_SpawnObject3 : EventAction
    {
        ...
        {
            <PreloadAssets>c__Iterator9A iteratora;
            iteratora = new <PreloadAssets>c__Iterator9A();
        ...
        [CompilerGenerated]
        private sealed class <PreloadAssets>c__Iterator9A : IEnumerator, IDisposable, IEnumerator<object>
        {
            internal int $PC;
            internal object $current;
            internal EventAction_SpawnObject3 <>f__this;

            public <PreloadAssets>c__Iterator9A()
            {
                base..ctor();
                return;
            }
