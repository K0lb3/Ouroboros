...
namespace SRPG
{
  ...
  public class UnitEquipmentWindow : MonoBehaviour, IFlowInterface
  {
    ...
    private void OnQuestSelect(SRPG_Button button)
    {
      ...
      UnitEquipmentWindow.\u003COnQuestSelect\u003Ec__AnonStorey390 selectCAnonStorey390 = new UnitEquipmentWindow.\u003COnQuestSelect\u003Ec__AnonStorey390();
      int index = this.GainedQuests.IndexOf(((Component) button).get_gameObject());
      // ISSUE: reference to a compiler-generated field
      selectCAnonStorey390.quest = DataSource.FindDataOfClass<QuestParam>(this.GainedQuests[index], (QuestParam) null);
      // ISSUE: reference to a compiler-generated field
      if (selectCAnonStorey390.quest == null)
        return;
      // ISSUE: reference to a compiler-generated field
      if (!selectCAnonStorey390.quest.IsDateUnlock(-1L))
      {
      ...
      else
      {
        ...
        if (Array.Find<QuestParam>(MonoSingleton<GameManager>.Instance.Player.AvailableQuests, new Predicate<QuestParam>(selectCAnonStorey390.\u003C\u003Em__450)) == null)
        {
        ...
        {
          // ISSUE: reference to a compiler-generated field
          GlobalVars.SelectedQuestID = selectCAnonStorey390.quest.iname;
