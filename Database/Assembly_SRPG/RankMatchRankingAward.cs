namespace SRPG
{
    ...
    public class RankMatchRankingAward : SRPG_ListBase
    {
        ...
        protected override void Start()
        {
            ...
            <Start>c__AnonStorey395 storey;
            storey = new <Start>c__AnonStorey395();
            storey.<>f__this = this;
            base.Start();
        ...
        Label_013D:
            ...
            storey.gm.GetVersusRankRankingRewardList(storey.gm.RankMatchScheduleId).ForEach(new Action<VersusRankRankingRewardParam>(storey.<>m__3E7));
            return;
        }

        [CompilerGenerated]
        private sealed class <Start>c__AnonStorey395
        {
            internal GameManager gm;
            internal RankMatchRankingAward <>f__this;

            public <Start>c__AnonStorey395()
            {
                base..ctor();
                return;
            }

            internal void <>m__3E7(VersusRankRankingRewardParam vrrr)
            {
                List<VersusRankReward> list;
                <Start>c__AnonStorey396 storey;
                storey = new <Start>c__AnonStorey396();
                storey.<>f__ref$917 = this;
                storey.item = Object.Instantiate<RankMatchClassListItem>(this.<>f__this.ListItem);
                DataSource.Bind<VersusRankRankingRewardParam>(storey.item.get_gameObject(), vrrr);
                ...
                this.gm.GetVersusRankClassRewardList(vrrr.RewardId).ForEach(new Action<VersusRankReward>(storey.<>m__3E8));
                return;
            }

            private sealed class <Start>c__AnonStorey396
            {
                internal RankMatchClassListItem item;
                internal RankMatchRankingAward.<Start>c__AnonStorey395 <>f__ref$917;

                public <Start>c__AnonStorey396()
                {
                    base..ctor();
                    return;
                }

                internal unsafe void <>m__3E8(VersusRankReward reward)
                {
                    GameObject obj2;
                    bool flag;
                    UnitParam param;
                    ...
                    goto Label_0159;
                Label_0030:
                    param = this.<>f__ref$917.gm.GetUnitParam(reward.IName);
                    if (param != null)
                    {
                        goto Label_004E;
                    }
                ...
                Label_004E:
                    ...
                    goto Label_015A;
                Label_006B:
                    param2 = this.<>f__ref$917.gm.GetItemParam(reward.IName);
                    if (param2 != null)
                    {
                        goto Label_0089;
                    }
                ...
                Label_00C0:
                    ...
                    goto Label_015A;
                Label_00D8:
                    param3 = this.<>f__ref$917.gm.GetAwardParam(reward.IName);
                    if (param3 != null)
                    {
                        goto Label_00F8;
                    }
                ...
                Label_00F8:
                    ...
                    goto Label_015A;
                Label_0116:
                    param4 = this.<>f__ref$917.gm.MasterParam.GetArtifactParam(reward.IName);
                    if (param4 != null)
                    {
                        goto Label_013B;
                    }
