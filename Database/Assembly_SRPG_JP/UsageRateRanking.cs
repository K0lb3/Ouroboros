  ...
  public class UsageRateRanking : MonoBehaviour, IFlowInterface
  {
    ...
    public void Start()
    {
      ...
      for (int index = 0; index < this.RankingToggle.Length; ++index)
      {
        ...
        UsageRateRanking.\u003CStart\u003Ec__AnonStorey3E6 startCAnonStorey3E6 = new UsageRateRanking.\u003CStart\u003Ec__AnonStorey3E6();
        // ISSUE: reference to a compiler-generated field
        startCAnonStorey3E6.\u003C\u003Ef__this = this;
        if (!Object.op_Equality((Object) this.RankingToggle[index], (Object) null))
        {
          // ISSUE: reference to a compiler-generated field
          startCAnonStorey3E6.index = index;
          // ISSUE: method pointer
          ((UnityEvent<bool>) this.RankingToggle[index].onValueChanged).AddListener(new UnityAction<bool>((object) startCAnonStorey3E6, __methodptr(\u003C\u003Em__491)));
        }
      }
    }
