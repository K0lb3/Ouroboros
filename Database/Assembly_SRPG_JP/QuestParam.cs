  ...
  public class QuestParam
  {
    ...
    private List<string> GetEntryQuestConditionsInternal(QuestCondParam condParam, bool titled = true, bool includeUnitLv = true, bool includeUnits = true)
    {
      ...
      if (condParam != null && condParam.jobset != null && (condParam.jobset.Length > 0 && Array.IndexOf<int>(condParam.jobset, 1) != -1))
      {
        ...
        if (!string.IsNullOrEmpty(str1))
        {
          ...
          string str2 = empty + LocalizedText.Get("sys.PARTYEDITOR_COND_JOBINDEX_VALUE", new object[1]
          {
            (object) str1
          });
          stringList1.Add(str2);
    ...
    public static QuestTypes ToQuestType(string name)
    {
      ...
      if (key != null)
      {
        ...
        if (QuestParam.\u003C\u003Ef__switch\u0024map11 == null)
        {
          // ISSUE: reference to a compiler-generated field
          QuestParam.\u003C\u003Ef__switch\u0024map11 = new Dictionary<string, int>(13)
          {
            {
              "Story",
              0
        ...
        int num;
        // ISSUE: reference to a compiler-generated field
        if (QuestParam.\u003C\u003Ef__switch\u0024map11.TryGetValue(key, out num))
        {
          switch (num)
          {
            case 0:
    ...
    public bool TransSectionGotoQuest(string questID, out QuestTypes quest_type, UIUtility.DialogResultEvent callback)
    {
      ...
      switch (quest.type)
      {
        ...
        case QuestTypes.Character:
          ...
          if (!this.TransSelectionGotoCharacter(questID, callback))
            return false;
          break;
        case QuestTypes.Tower:
    ...
    public static CollaboSkillParam.Pair GetCollaboSkillQuest(string quest_id)
    {
      ...
      QuestParam questParam = Array.Find<QuestParam>(instance.Quests, (Predicate<QuestParam>) (p => p.iname == quest_id));
      if (questParam == null)
        return (CollaboSkillParam.Pair) null;
      List<QuestParam> chapterIdQuestParam = QuestParam.GetSameChapterIDQuestParam(questParam.ChapterID);
      if (chapterIdQuestParam == null)
        return (CollaboSkillParam.Pair) null;
      using (List<QuestParam>.Enumerator enumerator = chapterIdQuestParam.GetEnumerator())
      {
        while (enumerator.MoveNext())
        {
          pair = CollaboSkillParam.IsLearnQuest(enumerator.Current.iname);
          if (pair != null)
            break;
        }
      }
