...
namespace SRPG
{
  ...
  public class SceneReplay : Scene, IFlowInterface
  {
    ...
    private IEnumerator StartQuestAsync(string questID)
    {
      ...
      return (IEnumerator) new SceneReplay.\u003CStartQuestAsync\u003Ec__Iterator81()
      {
        questID = questID,
        \u003C\u0024\u003EquestID = questID,
        \u003C\u003Ef__this = this
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new SceneReplay.\u003CDownloadQuestAsync\u003Ec__Iterator82()
      {
        quest = quest,
        \u003C\u0024\u003Equest = quest,
        \u003C\u003Ef__this = this
    ...
    private class State_Replay : State<SceneReplay>
    {
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new SceneReplay.State_Replay.\u003CExec\u003Ec__Iterator83()
        {
          \u003C\u003Ef__this = this
        };
      }
