...
namespace SRPG
{
  public class PlayerData
  {
    ...
    public IEnumerator SavePlayerPrefsAsync()
    {
      ...
      return (IEnumerator) new PlayerData.\u003CSavePlayerPrefsAsync\u003Ec__Iterator7E()
      {
        \u003C\u003Ef__this = this
      };
    }
    ...
    public void OnQuestWin(string questID, BattleCore.Record battleRecord = null)
    {
      ...
      if (quest.type == QuestTypes.Ordeal)
      {
        ...
        {
          using (List<SupportData>.Enumerator enumerator = GlobalVars.OrdealSupports.GetEnumerator())
          {
            while (enumerator.MoveNext())
            {
              SupportData current = enumerator.Current;
              if (current != null)
              {
                supportData = current;
                break;
