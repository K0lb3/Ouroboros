  ...
  public class RewardWindow : MonoBehaviour, IFlowInterface
  {
    ...
    private void Awake()
    {
      ...
      if (Object.op_Inequality((Object) this.ConceptCardTemplate, (Object) null))
        this.ConceptCardTemplate.get_gameObject().SetActive(false);
      if (Object.op_Inequality((Object) this.UnitTemplate, (Object) null))
        this.UnitTemplate.get_gameObject().SetActive(false);
    ...
    public virtual void Refresh()
    {
      ...
      if (Object.op_Inequality((Object) this.ConceptCardTemplate, (Object) null))
      {
        Transform parent = this.ConceptCardTemplate.get_transform().get_parent();
        this.RefreshConceptCards(dataOfClass, parent, this.ConceptCardTemplate);
      }
      if (Object.op_Inequality((Object) this.UnitTemplate, (Object) null))
      {
        Transform parent = this.UnitTemplate.get_transform().get_parent();
      ...
      if (!Object.op_Inequality((Object) this.Caution, (Object) null) || !dataOfClass.IsOverLimit)
        return;
      this.Caution.get_transform().SetSiblingIndex(this.Caution.get_transform().get_parent().get_childCount());
      this.Caution.get_gameObject().SetActive(true);
    }
