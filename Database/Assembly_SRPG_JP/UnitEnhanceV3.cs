...
namespace SRPG
{
  ...
  public class UnitEnhanceV3 : MonoBehaviour, IFlowInterface
  {
    ...
    private IEnumerator Start()
    {
      ...
      return (IEnumerator) new UnitEnhanceV3.\u003CStart\u003Ec__Iterator14A()
      {
        \u003C\u003Ef__this = this
      };
    }
    ...
    private void OnDestroy()
    {
      ...
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.mUnlockTobiraWindow, (UnityEngine.Object) null))
        UnityEngine.Object.Destroy((UnityEngine.Object) ((Component) this.mUnlockTobiraWindow).get_gameObject());
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitEnhanceV3.\u003COnSceneChangeAsync\u003Ec__Iterator14B()
      {
        \u003C\u003Ef__this = this
      };
    }
    ...
    private void OnEquipAllResult(WWWResult www)
    {
      ...
      else
      {
        ...
        EquipData[] rankupEquips = unitDataByUniqueId1.GetRankupEquips(this.mCurrentUnit.JobIndex);
        int num1 = 0;
        ...
        if (unitDataByUniqueId1.CurrentJob.Rank > 1)
          num1 += (unitDataByUniqueId1.CurrentJob.Rank - 1) * 6;
        try
        {
          GameManager instance = MonoSingleton<GameManager>.Instance;
          instance.Deserialize(jsonObject.body.player);
        ...
        if (unitDataByUniqueId2.CurrentJob.Rank > 1)
          num2 += (unitDataByUniqueId2.CurrentJob.Rank - 1) * 6;
    ...
    public void BeginStatusChangeCheck()
    {
      ...
      this.mCurrentEquipConceptCardId = (long) (this.mCurrentUnit.ConceptCard != null ? this.mCurrentUnit.ConceptCard.UniqueID : (OLong) 0L);
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitEnhanceV3.\u003CPostEquip\u003Ec__Iterator14C()
      {
        \u003C\u003Ef__this = this
      };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitEnhanceV3.\u003CPostJobMaster\u003Ec__Iterator14D()
      {
        \u003C\u003Ef__this = this
      };
    }
    ...
    private bool TabChange(SRPG_Button button)
    {
      if (!((Selectable) button).IsInteractable())
        return false;
      using (Dictionary<UnitEnhanceV3.eTabButtons, SRPG_ToggleButton>.KeyCollection.Enumerator enumerator = this.mTabButtons.Keys.GetEnumerator())
      {
        while (enumerator.MoveNext())
        {
          UnitEnhanceV3.eTabButtons current = enumerator.Current;
          if (this.mTabButtons.ContainsKey(current) && !UnityEngine.Object.op_Equality((UnityEngine.Object) this.mTabButtons[current], (UnityEngine.Object) null))
          {
            bool flag = UnityEngine.Object.op_Equality((UnityEngine.Object) this.mTabButtons[current], (UnityEngine.Object) button);
            if (flag)
            {
              this.mActiveTabIndex = current;
            ...
            this.mTabButtons[current].IsOn = flag;
            if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.mTabPages[(int) current], (UnityEngine.Object) null))
            {
              Canvas component = (Canvas) ((Component) this.mTabPages[(int) current]).GetComponent<Canvas>();
    ...
    private void InitEquipmentPanel(UnitEnhancePanel panel)
    {
      ...
      if (!UnityEngine.Object.op_Inequality((UnityEngine.Object) panel.mConceptCardSlot, (UnityEngine.Object) null))
        return;
      // ISSUE: method pointer
      ((UnityEvent) panel.mConceptCardSlot.SelectButton.get_onClick()).AddListener(new UnityAction((object) this, __methodptr(OnEquipCardSlotSelect)));
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitEnhanceV3.\u003CPostUnitLevelUp\u003Ec__Iterator14E()
      {
        prevLv = prevLv,
        \u003C\u0024\u003EprevLv = prevLv,
        \u003C\u003Ef__this = this
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitEnhanceV3.\u003CWaitForKyokaRequestAsync\u003Ec__Iterator14F()
      {
    ...
    {
      return !this.IsStopPlayLeftVoice && (!UnityEngine.Object.op_Inequality((UnityEngine.Object) this.mUnitModelViewer, (UnityEngine.Object) null) || !((Component) this.mUnitModelViewer).get_gameObject().get_activeSelf()) && (!UnityEngine.Object.op_Inequality((UnityEngine.Object) this.mTobiraInventoryWindow, (UnityEngine.Object) null) || !((Component) this.mTobiraInventoryWindow).get_gameObject().get_activeSelf());
    }
    ...
    private void OnCloseEquipConceptCardWindow()
    {
      ...
      if (this.mCurrentUnit.ConceptCard == null || (long) this.mCurrentUnit.ConceptCard.UniqueID == this.mCurrentEquipConceptCardId || this.mCurrentUnit.GetEnableConceptCardSkins(-1).Length <= 0)
        return;
      UIUtility.ConfirmBox(LocalizedText.Get("sys.CONCEPT_CARD_CONFIRM_CHANGE_SKIN", new object[1]
      {
        (object) this.mCurrentUnit.ConceptCard.Param.name
      }), new UIUtility.DialogResultEvent(this.AcceptChangeSkinByEquipConceptCard), new UIUtility.DialogResultEvent(this.CancelChangeSkinByEquipConceptCard), (GameObject) null, false, -1, (string) null, (string) null);
    }
    ...
    private void AcceptChangeSkinByEquipConceptCard(GameObject obj)
    {
      ...
      if (conceptCardSkins.Length <= 0)
        return;
      this.OnSkinSelect(conceptCardSkins[0]);
      this.OnSkinDecideAll(conceptCardSkins[0]);
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitEnhanceV3.\u003CPostJobChange\u003Ec__Iterator150()
      {
        \u003C\u003Ef__this = this
      };
    }
    ...
    private void OnArtifactClick(GenericSlot slot, bool interactable)
    {
      ...
      else
      {
        ...
        {
          this.mArtifactSelector = (GameObject) UnityEngine.Object.Instantiate<GameObject>((M0) AssetManager.Load<GameObject>(this.PREFAB_PATH_ARTIFACT_WINDOW));
        }
        else
        {
    ...
    private ArtifactData[] GetViewArtifact()
    {
      ...
      {
        DataSource.FindDataOfClass<ArtifactData>(((Component) this.mEquipmentPanel.ArtifactSlot).get_gameObject(), (ArtifactData) null),
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitEnhanceV3.\u003CPostJobRankUp\u003Ec__Iterator151()
      {
    ...
    private void RebuildUnitData()
    {
      ...
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.mEquipmentPanel.mEquipConceptCardIcon, (UnityEngine.Object) null))
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitEnhanceV3.\u003CRefreshAsync\u003Ec__Iterator152()
      {
        immediate = immediate,
    ...
    private void SetPreviewVisible(bool visible)
    {
      ...
      if (!UnityEngine.Object.op_Inequality((UnityEngine.Object) UnitManagementWindow.Instance.UnitModelPreviewBase, (UnityEngine.Object) null) || ((Component) UnitManagementWindow.Instance.UnitModelPreviewBase).get_gameObject().get_activeSelf() || !visible)
        return;
      ((Component) UnitManagementWindow.Instance.UnitModelPreviewBase).get_gameObject().SetActive(true);
    }
    ...
    private void ReloadPreviewModels()
    {
      ...
      for (int jobIndex = 0; jobIndex < this.mCurrentUnit.Jobs.Length; ++jobIndex)
      {
        ...
        if (this.mCurrentUnit.Jobs[jobIndex] != null && this.mCurrentUnit.Jobs[jobIndex].Param != null)
        {
          ...
          gameObject.get_transform().SetParent(UnitManagementWindow.Instance.UnitModelPreviewParent, false);
      ...
      gameObject1.get_transform().SetParent(UnitManagementWindow.Instance.UnitModelPreviewParent, false);
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitEnhanceV3.\u003CLoadAllUnitImage\u003Ec__Iterator153()
      {
        \u003C\u003Ef__this = this
      };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitEnhanceV3.\u003CRefreshUnitImage\u003Ec__Iterator154()
      {
        \u003C\u003Ef__this = this
      };
    }
    ...
    public void RefreshJobIcon(GameObject target, int job_index)
    {
      ...
      ((UnitInventoryJobIcon) target.GetComponent<UnitInventoryJobIcon>()).SetParam(this.mCurrentUnit, this.mJobSetDatas[index][0], this.mJobSetDatas[index][1], is_avtive_job, UnitInventoryJobIcon.eViewMode.UNIT_DETAIL);
    ...
    private void RefreshJobIcons(bool is_hide = false)
    {
      ...
      for (int index = 0; index < this.mJobIconScrollListController.Items.Count; ++index)
      {
        if (((UnityEngine.Object) this.mJobIconScrollListController.Items[index].job_icon.BaseJobIconButton).get_name() == this.mSelectedJobIndex.ToString())
          objects.Add(((Component) this.mJobIconScrollListController.Items[index].job_icon).get_gameObject());
        if (((Component) this.mJobIconScrollListController.Items[index].job_icon.CcJobButton).get_gameObject().get_activeSelf() && ((UnityEngine.Object) this.mJobIconScrollListController.Items[index].job_icon.CcJobButton).get_name() == this.mSelectedJobIndex.ToString())
          objects.Add(((Component) this.mJobIconScrollListController.Items[index].job_icon).get_gameObject());
      }
    ...
    private void UpdateJobSlotStates(bool immediate)
    {
      ...
      {
        bool is_on = ((UnityEngine.Object) componentsInChildren[index].BaseJobIconButton).get_name() == this.mCurrentUnit.JobIndex.ToString();
    ...
    private void UpdateUnitEvolutionButtonState(bool immediate = false)
    {
      if (!UnityEngine.Object.op_Inequality((UnityEngine.Object) this.UnitEvolutionButton, (UnityEngine.Object) null))
        return;
      ((Component) this.UnitEvolutionButton).get_gameObject().SetActive(true);
    ...
    {
      ((Component) this.UnitUnlockTobiraButton).get_gameObject().SetActive(false);
      ((Component) this.UnitGoTobiraButton).get_gameObject().SetActive(false);
      ...
      if (this.mCurrentUnit.IsUnlockTobira)
      {
        if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.UnitGoTobiraButton, (UnityEngine.Object) null))
          ((Component) this.UnitGoTobiraButton).get_gameObject().SetActive(true);
        ((Component) this.UnitEvolutionButton).get_gameObject().SetActive(false);
      ...
      else
      {
        if (!flag1)
          return;
        ((Component) this.UnitEvolutionButton).get_gameObject().SetActive(false);
        ((Component) this.UnitUnlockTobiraButton).get_gameObject().SetActive(true);
        if (string.IsNullOrEmpty(this.UnitTobiraButtonHilitBool))
          return;
        Animator component = (Animator) ((Component) this.UnitUnlockTobiraButton).GetComponent<Animator>();
    ...
    {
      this.ChangeJobSlot(int.Parse(((UnityEngine.Object) target).get_name()), target);
    }
    ...
    private void ChangeJobSlot(int index, GameObject target = null)
    {
      ...
      if (UnityEngine.Object.op_Equality((UnityEngine.Object) target, (UnityEngine.Object) null))
        this.ScrollClampedJobIcons.Focus(((Component) this.mJobIconScrollListController.Items[index].job_icon).get_gameObject(), false, false, 0.0f);
      else
    ...
    public UnitEquipmentWindow EquipmentWindow
    {
      ...
      get
      {
        if (UnityEngine.Object.op_Equality((UnityEngine.Object) this.mEquipmentWindow, (UnityEngine.Object) null) && UnityEngine.Object.op_Inequality((UnityEngine.Object) UnitManagementWindow.Instance, (UnityEngine.Object) null))
        {
          ...
          {
            UnitEquipmentWindow component = (UnitEquipmentWindow) ((GameObject) UnityEngine.Object.Instantiate<GameObject>((M0) gameObject)).GetComponent<UnitEquipmentWindow>();
            ((Component) component).get_transform().SetParent(((Component) UnitManagementWindow.Instance).get_transform(), false);
    ...
    public UnitKakeraWindow KakeraWindow
    {
      ...
      get
      {
        if (UnityEngine.Object.op_Equality((UnityEngine.Object) this.mKakeraWindow, (UnityEngine.Object) null) && UnityEngine.Object.op_Inequality((UnityEngine.Object) UnitManagementWindow.Instance, (UnityEngine.Object) null))
        {
          ...
          if (UnityEngine.Object.op_Inequality((UnityEngine.Object) gameObject, (UnityEngine.Object) null))
          {
            UnitKakeraWindow component = (UnitKakeraWindow) ((GameObject) UnityEngine.Object.Instantiate<GameObject>((M0) gameObject)).GetComponent<UnitKakeraWindow>();
            ((Component) component).get_transform().SetParent(((Component) UnitManagementWindow.Instance).get_transform(), false);
    ...
    public UnitTobiraInventory TobiraInventoryWindow
    {
      set
      {
        ...
        if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.mTobiraInventoryWindow, (UnityEngine.Object) null))
          ;
      }
      get
      {
        if (UnityEngine.Object.op_Equality((UnityEngine.Object) this.mTobiraInventoryWindow, (UnityEngine.Object) null) && UnityEngine.Object.op_Inequality((UnityEngine.Object) UnitManagementWindow.Instance, (UnityEngine.Object) null))
        {
          ...
          if (UnityEngine.Object.op_Inequality((UnityEngine.Object) gameObject, (UnityEngine.Object) null))
          {
            UnitTobiraInventory component = (UnitTobiraInventory) ((GameObject) UnityEngine.Object.Instantiate<GameObject>((M0) gameObject)).GetComponent<UnitTobiraInventory>();
            ((Component) component).get_transform().SetParent(((Component) UnitManagementWindow.Instance).get_transform(), false);
    ...
    private void OnWindowStateChange(GameObject go, bool visible)
    {
      ...
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) UnitManagementWindow.Instance.UnitModelPreviewBase, (UnityEngine.Object) null))
        ((Component) UnitManagementWindow.Instance.UnitModelPreviewBase).get_gameObject().SetActive(false);
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitEnhanceV3.\u003CWaitForKyokaRequestAndInvokeUserClose\u003Ec__Iterator155()
      {
        \u003C\u003Ef__this = this
      };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitEnhanceV3.\u003CAbilityRankUpSkillUnlockEffect\u003Ec__Iterator156()
      {
        \u003C\u003Ef__this = this
      };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitEnhanceV3.\u003CPostAbilityRankUp\u003Ec__Iterator157()
      {
        newSkills = newSkills,
        \u003C\u0024\u003EnewSkills = newSkills,
        \u003C\u003Ef__this = this
    ...
    public void OpenKakeraWindow()
    {
      ...
      ((WindowController) ((Component) this).GetComponent<WindowController>()).SetCollision(false);
      ((WindowController) ((Component) this.KakeraWindow).GetComponent<WindowController>()).OnWindowStateChange = new WindowController.WindowStateChangeEvent(this.OnKakuseiCancel);
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitEnhanceV3.\u003C_OpenProfileWindow\u003Ec__Iterator158()
      {
        \u003C\u003Ef__this = this
      };
    }
    ...
    private void OnUnitKakusei()
    {
      ...
      {
        ((WindowController) ((Component) this.KakeraWindow).GetComponent<WindowController>()).Close();
        ((WindowController) ((Component) this.KakeraWindow).GetComponent<WindowController>()).OnWindowStateChange = new WindowController.WindowStateChangeEvent(this.OnKakuseiAccept);
    ...
    private void OnKakuseiAccept(GameObject go, bool visible)
    {
      if (visible)
        return;
      ((WindowController) ((Component) this.KakeraWindow).GetComponent<WindowController>()).OnWindowStateChange = (WindowController.WindowStateChangeEvent) null;
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitEnhanceV3.\u003CPostUnitKakusei\u003Ec__Iterator159()
      {
        \u003C\u003Ef__this = this
      };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitEnhanceV3.\u003CEvolutionButtonClickSync\u003Ec__Iterator15A()
      {
        \u003C\u003Ef__this = this
      };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitEnhanceV3.\u003CPostUnitEvolution\u003Ec__Iterator15B()
      {
        \u003C\u003Ef__this = this
      };
    }
    ...
    private void OpenUnlockTobiraWindow()
    {
      ...
      if (!UnityEngine.Object.op_Inequality((UnityEngine.Object) gameObject, (UnityEngine.Object) null))
        return;
      this.mUnlockTobiraWindow = (UnitUnlockTobiraWindow) ((GameObject) UnityEngine.Object.Instantiate<GameObject>((M0) gameObject)).GetComponent<UnitUnlockTobiraWindow>();
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitEnhanceV3.\u003C_TobiraUIActive\u003Ec__Iterator15C()
      {
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitEnhanceV3.\u003CUnitUnlockTobira\u003Ec__Iterator15D()
      {
        \u003C\u003Ef__this = this
      };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitEnhanceV3.\u003CPostUnitUnlockTobira\u003Ec__Iterator15E()
      {
        \u003C\u003Ef__this = this
      };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitEnhanceV3.\u003CShiftUnitAsync\u003Ec__Iterator15F()
      {
    ...
    private void OnCharacterQuestOpen(SRPG_Button button, bool isRestore)
    {
      ...
      if (UnityEngine.Object.op_Equality((UnityEngine.Object) gameObject, (UnityEngine.Object) null))
        return;
      UnitCharacterQuestWindow component = (UnitCharacterQuestWindow) ((GameObject) UnityEngine.Object.Instantiate<GameObject>((M0) gameObject)).GetComponent<UnitCharacterQuestWindow>();
      if (UnityEngine.Object.op_Equality((UnityEngine.Object) component, (UnityEngine.Object) null))
        return;
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitEnhanceV3.\u003COpenCharacterQuestPopupInternalAsync\u003Ec__Iterator160()
      {
        \u003C\u003Ef__this = this
      };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitEnhanceV3.\u003COnSkinSelectOpenAsync\u003Ec__Iterator161()
      {
        isView = isView,
        \u003C\u0024\u003EisView = isView,
        \u003C\u003Ef__this = this
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitEnhanceV3.\u003CShowUnlockSkillEffect\u003Ec__Iterator162()
      {
        \u003C\u003Ef__this = this
      };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitEnhanceV3.\u003CPlayTobiraOpenEffect\u003Ec__Iterator163()
      {
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitEnhanceV3.\u003CPlayTobiraLevelupEffect\u003Ec__Iterator164()
      {
        tobira = tobira,
        \u003C\u0024\u003Etobira = tobira,
        \u003C\u003Ef__this = this
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitEnhanceV3.\u003CPlayTobiraLevelupMaxEffect\u003Ec__Iterator165()
      {
    ...
    public void RefreshTobiraBgAnimation(TobiraData tobira, bool is_immediate = false)
    {
      ...
      // ISSUE: explicit reference operation
      // ISSUE: explicit reference operation
      if (!flag ? ((AnimatorStateInfo) @animatorStateInfo).IsName("open") || ((AnimatorStateInfo) @animatorStateInfo).IsName("opened") : ((AnimatorStateInfo) @animatorStateInfo).IsName("close") || ((AnimatorStateInfo) @animatorStateInfo).IsName("closed"))
        return;
    ...
    public void Activated(int pinID)
    {
      switch (pinID)
      {
        ...
        case 110:
          ...
          {
            this.mUnitModelViewer = (UnitModelViewer) ((GameObject) UnityEngine.Object.Instantiate<GameObject>((M0) AssetManager.Load<GameObject>(this.PREFAB_PATH_MODEL_VIEWER))).GetComponent<UnitModelViewer>();
            ((Component) this.mUnitModelViewer).get_transform().SetParent(((Component) this).get_transform(), false);
            ((Component) this.mUnitModelViewer).get_transform().SetParent(this.mUnitModelViewerParent, false);
          ...
          ((Component) this.mUnitModelViewer).get_gameObject().SetActive(true);
          break;
        case 111:
          if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.mUnitModelViewer, (UnityEngine.Object) null))
          {
            this.mUnitModelViewer.ResetTouchControlArea();
            ((Component) this.mUnitModelViewer).get_gameObject().SetActive(false);
          }
        ...
        case 401:
          ...
          if (!UnityEngine.Object.op_Inequality((UnityEngine.Object) component, (UnityEngine.Object) null) || !((Behaviour) component).get_enabled() || this.mCurrentUnitID <= 0L)
            break;
          this.RefreshEquipments(-1);
          this.UpdateJobRankUpButtonState();
          this.UpdateJobChangeButtonState();
