  ...
  public class DropItemEffect : MonoBehaviour
  {
    ...
    private void State_Setup()
    {
      ...
      if (this.m_DropItem.isItem)
        DataSource.Bind<ItemParam>(((Component) this).get_gameObject(), this.m_DropItem.itemParam);
      else if (this.m_DropItem.isConceptCard)
        DataSource.Bind<ConceptCardParam>(((Component) this).get_gameObject(), this.m_DropItem.conceptCardParam);
      if ((bool) this.m_DropItem.is_secret)
      {
        ItemIcon component = (ItemIcon) ((Component) this).get_gameObject().GetComponent<DropItemIcon>();
        if (UnityEngine.Object.op_Inequality((UnityEngine.Object) component, (UnityEngine.Object) null))
          component.IsSecret = true;
      }
      GameParameter.UpdateAll(((Component) this).get_gameObject());
      this.m_ItemIcon = (ItemIcon) ((Component) this).get_gameObject().GetComponent<DropItemIcon>();
