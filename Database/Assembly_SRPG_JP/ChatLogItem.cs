...
namespace SRPG
{
  public class ChatLogItem : MonoBehaviour
  {
    ...
    public void Refresh(ChatLogParam param, ChatWindow.MessageTemplateType type)
    {
      ...
      {
        if (param.message_type != (byte) 2 || !UnityEngine.Object.op_Inequality((UnityEngine.Object) this.mRoot, (UnityEngine.Object) null) || !this.mRoot.get_activeInHierarchy())
          return;
        if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.mStampRoot, (UnityEngine.Object) null))
    ...
    private IEnumerator RefreshTextLine(string text)
    {
      ...
      return (IEnumerator) new ChatLogItem.\u003CRefreshTextLine\u003Ec__IteratorEF()
      {
        text = text,
        \u003C\u0024\u003Etext = text,
        \u003C\u003Ef__this = this
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new ChatLogItem.\u003CRefreshStamp\u003Ec__IteratorF0()
      {
        id = id,
        \u003C\u0024\u003Eid = id,
        \u003C\u003Ef__this = this
