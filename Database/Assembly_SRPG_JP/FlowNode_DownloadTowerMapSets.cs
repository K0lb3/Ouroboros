...
namespace SRPG
{
  ...
  public class FlowNode_DownloadTowerMapSets : FlowNode
  {
    ...
    private IEnumerator DownloadFloorParams()
    {
      ...
      return (IEnumerator) new FlowNode_DownloadTowerMapSets.\u003CDownloadFloorParams\u003Ec__IteratorB3()
      {
        \u003C\u003Ef__this = this
      };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new FlowNode_DownloadTowerMapSets.\u003CDownloadFloorParamAsync\u003Ec__IteratorB4()
      {
        \u003C\u003Ef__this = this
      };
    }
