...
namespace SRPG
{
  ...
  [FlowNode.Pin(1000, "LoadOrdeal", FlowNode.PinTypes.Input, 7)]
  ...
  [FlowNode.Pin(700, "LoadVersusCpu", FlowNode.PinTypes.Input, 23)]
  [FlowNode.Pin(800, "QuestResumeFailed_IsRehash", FlowNode.PinTypes.Output, 24)]
  ...
  public class FlowNode_StartQuest : FlowNode_Network
  {
    ...
    public override void OnSuccess(WWWResult www)
    {
      ...
      else
      {
        ...
        {
          Network.RemoveAPI();
          if (jsonObject.body.is_rehash != 0)
          {
            GlobalVars.BtlID.Set(jsonObject.body.btlid);
    ...
    protected IEnumerator StartScene(BattleCore.Json_Battle json)
    {
      ...
      return (IEnumerator) new FlowNode_StartQuest.\u003CStartScene\u003Ec__IteratorBE()
      {
        json = json,
        \u003C\u0024\u003Ejson = json,
        \u003C\u003Ef__this = this
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new FlowNode_StartQuest.\u003CStartAudience\u003Ec__IteratorBF()
      {
        \u003C\u003Ef__this = this
      };
    }
