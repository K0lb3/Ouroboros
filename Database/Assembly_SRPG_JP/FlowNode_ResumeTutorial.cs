...
namespace SRPG
{
  ...
  public class FlowNode_ResumeTutorial : FlowNode
  {
    ...
    private IEnumerator WaitCompleteTutorialAsync()
    {
      ...
      return (IEnumerator) new FlowNode_ResumeTutorial.\u003CWaitCompleteTutorialAsync\u003Ec__IteratorC8()
      {
        \u003C\u003Ef__this = this
      };
    }
    ...
    {
      BattleCore.RemoveSuspendData();
      Network.RequestAPI((WebAPI) new ReqBtlComEnd((long) GlobalVars.BtlID, 0, BtlResultTypes.Cancel, (int[]) null, (int[]) null, (int[]) null, (int[]) null, (string[]) null, (Dictionary<OString, OInt>) null, new Network.ResponseCallback(this.OnBtlComEnd), BtlEndTypes.com, (string) null, (string) null, 0, (string) null, is_rehash, new bool?()), false);
    ...
    {
      BattleCore.RemoveSuspendData();
      Network.RequestAPI((WebAPI) new ReqTowerBtlComEnd((long) GlobalVars.BtlID, (Unit[]) null, (Unit[]) null, 0, 0, (byte) 0, BtlResultTypes.Cancel, (RandDeckResult[]) null, new Network.ResponseCallback(this.OnBtlComEnd), (string) null, (string) null, (int[]) null, (int[]) null), false);
      GlobalVars.BtlID.Set(0L);
    }
    ...
    {
      BattleCore.RemoveSuspendData();
      Network.RequestAPI((WebAPI) new ReqBtlComEnd((long) GlobalVars.BtlID, 0, BtlResultTypes.Cancel, (int[]) null, (int[]) null, (int[]) null, (int[]) null, (string[]) null, (Dictionary<OString, OInt>) null, new Network.ResponseCallback(this.OnBtlComEnd), BtlEndTypes.multi, (string) null, (string) null, 0, (string) null, false, new bool?()), false);
      GlobalVars.BtlID.Set(0L);
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new FlowNode_ResumeTutorial.\u003CLoadSceneAsync\u003Ec__IteratorC9()
      {
        sceneName = sceneName,
        \u003C\u0024\u003EsceneName = sceneName,
        \u003C\u003Ef__this = this
