...
namespace SRPG
{
  ...
  public class ChatStamp : MonoBehaviour, IFlowInterface
  {
    ...
    private void Refresh()
    {
      ...
      for (int index = 0; index < this.mStampObjects.Length && num + index < this.mStampParams.Length; ++index)
      {
        ...
        if (mStampParam != null)
        {
          ...
          ChatStamp.\u003CRefresh\u003Ec__AnonStorey314 refreshCAnonStorey314 = new ChatStamp.\u003CRefresh\u003Ec__AnonStorey314();
          // ISSUE: reference to a compiler-generated field
          refreshCAnonStorey314.\u003C\u003Ef__this = this;
          // ISSUE: reference to a compiler-generated field
          refreshCAnonStorey314.index = index;
          // ISSUE: reference to a compiler-generated field
          refreshCAnonStorey314.id = mStampParam.id;
          ...
          if (Object.op_Inequality((Object) component2, (Object) null))
          {
            ...
            // ISSUE: method pointer
            ((UnityEvent) component2.get_onClick()).AddListener(new UnityAction((object) refreshCAnonStorey314, __methodptr(\u003C\u003Em__2B8)));
          }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new ChatStamp.\u003CLoadStampImages\u003Ec__IteratorF1()
      {
        \u003C\u003Ef__this = this
      };
    }
