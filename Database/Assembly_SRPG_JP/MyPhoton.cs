  ...
  public class MyPhoton : PunMonoSingleton<MyPhoton>
  {
    ...
    public List<MyPhoton.MyRoom> GetRoomList()
    {
      ...
      foreach (global::RoomInfo room in PhotonNetwork.GetRoomList())
      {
        ...
        {
          GameUtility.Binary2Object<string>(out myRoom.json, (byte[]) customProperties.get_Item((object) "json"));
          ...
          if (((Dictionary<object, object>) customProperties).ContainsKey((object) "draft"))
            myRoom.draft = (bool) customProperties.get_Item((object) "draft");
        }
    ...
    public MyPhoton.MyPlayer GetMyPlayer()
    {
      ...
      if (customProperties != null && ((Dictionary<object, object>) customProperties).Count > 0)
      {
        GameUtility.Binary2Object<string>(out myPlayer.json, (byte[]) customProperties.get_Item((object) "json"));
    ...
    public void SetResumeMyPlayer(int playerID = 0)
    {
      ...
      if (customProperties != null && ((Dictionary<object, object>) customProperties).ContainsKey((object) "json"))
        numArray = (byte[]) customProperties.get_Item((object) "json");
      Hashtable propertiesToSet = new Hashtable();
      ...
      if (floor != -1)
      {
        ...
        foreach (global::RoomInfo roomInfo in roomList)
        {
          ...
          if (((Dictionary<object, object>) customProperties).ContainsKey((object) "MatchType") && VersusHash == (string) customProperties.get_Item((object) "MatchType"))
          {
            ...
            {
              string str = (string) customProperties.get_Item((object) "BlockList");
            ...
            if ((!((Dictionary<object, object>) customProperties).ContainsKey((object) "start") || !(bool) customProperties.get_Item((object) "start")) && (floor == -1 || !((Dictionary<object, object>) customProperties).ContainsKey((object) nameof (floor)) || (int) customProperties.get_Item((object) nameof (floor)) == floor) && (pass == -1 || !((Dictionary<object, object>) customProperties).ContainsKey((object) "Lock") || !(bool) customProperties.get_Item((object) "Lock")))
        ...
        if (roomInfoList1 != null && roomInfoList1.Count > 0)
        {
          ...
          if (GlobalVars.BlockList != null && GlobalVars.BlockList.Count > 0)
          {
            ...
            using (List<global::RoomInfo>.Enumerator enumerator = roomInfoList2.GetEnumerator())
            {
              while (enumerator.MoveNext())
              {
                global::RoomInfo current = enumerator.Current;
                Hashtable customProperties = current.CustomProperties;
                if (((Dictionary<object, object>) customProperties).ContainsKey((object) "uid"))
                {
                  string target_uid = (string) customProperties.get_Item((object) "uid");
                  if (blockList.FindIndex((Predicate<string>) (uid => uid == target_uid)) == -1)
                  {
                    flag2 = true;
                    roomName1 = current.Name;
                    break;
                  }
                }
              }
    ...
    public bool JoinRankMatchRoomCheckParam(string playerJson, int lv, int lvRange, string myuid, int score, int scoreRangeMax, int scoreRangeMin, int type, string[] exclude_uids)
    {
      ...
      {
        Hashtable customProperties = roomInfo.CustomProperties;
        if (((Dictionary<object, object>) customProperties).ContainsKey((object) "MatchType") && versusKey == (string) customProperties.get_Item((object) "MatchType"))
        {
          if (((Dictionary<object, object>) customProperties).ContainsKey((object) "uid") && exclude_uids != null && exclude_uids.Length > 0)
          {
            string strA = (string) customProperties.get_Item((object) "uid");
            bool flag2 = false;
          ...
          if (((Dictionary<object, object>) customProperties).ContainsKey((object) nameof (score)) && (!((Dictionary<object, object>) customProperties).ContainsKey((object) "start") || !(bool) customProperties.get_Item((object) "start")))
            roomInfoList.Add(roomInfo);
        }
      }
      roomInfoList.Sort((Comparison<global::RoomInfo>) ((a, b) =>
      {
        ...
        if (((Dictionary<object, object>) customProperties1).ContainsKey((object) nameof (score)))
          num1 = Math.Abs(score - (int) customProperties1.get_Item((object) nameof (score)));
        ...
        if (((Dictionary<object, object>) customProperties2).ContainsKey((object) nameof (score)))
          num2 = Math.Abs(score - (int) customProperties2.get_Item((object) nameof (score)));
        return num1 - num2;
      }));
      if (scoreRangeMin != -1)
      {
        ...
        using (List<global::RoomInfo>.Enumerator enumerator = roomInfoList.GetEnumerator())
        {
          while (enumerator.MoveNext())
          {
            ...
            {
              int num3 = (int) customProperties.get_Item((object) nameof (score));
              if (num1 <= num3 && num3 <= num2)
              {
                if (lvRange != -1 && ((Dictionary<object, object>) customProperties).ContainsKey((object) "plv"))
                {
                  int num4 = lv - lvRange;
                  int num5 = lv + lvRange;
                  int num6 = (int) customProperties.get_Item((object) "plv");
      ...
      if (!flag1)
      {
        using (List<global::RoomInfo>.Enumerator enumerator = roomInfoList.GetEnumerator())
        {
          while (enumerator.MoveNext())
          {
            global::RoomInfo current = enumerator.Current;
            Hashtable customProperties = current.CustomProperties;
            if (((Dictionary<object, object>) customProperties).ContainsKey((object) nameof (type)) && (int) customProperties.get_Item((object) nameof (type)) == type)
            {
              if (lvRange != -1 && ((Dictionary<object, object>) customProperties).ContainsKey((object) "plv"))
              {
                int num1 = lv - lvRange;
                int num2 = lv + lvRange;
                int num3 = (int) customProperties.get_Item((object) "plv");
    ...
    public bool AddRoomParam(string key, string param)
    {
      ...
      ((Dictionary<object, object>) propertiesToSet).Add((object) key, (object) GameUtility.Object2Binary<string>(param));
