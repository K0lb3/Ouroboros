...
namespace SRPG
{
  ...
  public class ProductList : MonoBehaviour, IFlowInterface
  {
    ...
    private void RefreshItems(bool is_start)
    {
      ...
      {
        GameObject gameObject = !(products[index].productID == (string) MonoSingleton<GameManager>.Instance.MasterParam.FixParam.VipCardProduct) && !false ? (GameObject) Object.Instantiate<GameObject>((M0) this.ItemTemplate) : (GameObject) Object.Instantiate<GameObject>((M0) this.ItemVipTemplate);
