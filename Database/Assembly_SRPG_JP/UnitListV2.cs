  ...
  public class UnitListV2 : SRPG_FixedList, IFlowInterface, ISortableList
  {
    ...
    protected virtual void Awake()
    {
      ...
      for (int index = 0; index < this.UnitToggle.Count; ++index)
      {
        ...
        UnitListV2.\u003CAwake\u003Ec__AnonStorey3A7 awakeCAnonStorey3A7 = new UnitListV2.\u003CAwake\u003Ec__AnonStorey3A7();
        // ISSUE: reference to a compiler-generated field
        awakeCAnonStorey3A7.\u003C\u003Ef__this = this;
        if (!UnityEngine.Object.op_Equality((UnityEngine.Object) this.UnitToggle[index], (UnityEngine.Object) null))
        {
          // ISSUE: reference to a compiler-generated field
          awakeCAnonStorey3A7.index = index;
          // ISSUE: method pointer
          ((UnityEvent<bool>) this.UnitToggle[index].onValueChanged).AddListener(new UnityAction<bool>((object) awakeCAnonStorey3A7, __methodptr(\u003C\u003Em__413)));
        }
      }
    }
