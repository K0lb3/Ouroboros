  ...
  public class GachaExciteMaster
  {
    ...
    private static int ColorString2Int(string cstr)
    {
      ...
      if (key != null)
      {
        ...
        if (GachaExciteMaster.\u003C\u003Ef__switch\u0024map9 == null)
        {
          // ISSUE: reference to a compiler-generated field
          GachaExciteMaster.\u003C\u003Ef__switch\u0024map9 = new Dictionary<string, int>(3)
          {
            {
              "blue",
              0
        ...
        int num;
        // ISSUE: reference to a compiler-generated field
        if (GachaExciteMaster.\u003C\u003Ef__switch\u0024map9.TryGetValue(key, out num))
        {
          switch (num)
          {
            case 0:
