...
namespace SRPG
{
  public class BattleCameraControl : MonoBehaviour
  {
    ...
    public void OnEventCall(string key, string value)
    {
      ...
      if (BattleCameraControl.\u003C\u003Ef__switch\u0024map5 == null)
      {
        // ISSUE: reference to a compiler-generated field
        BattleCameraControl.\u003C\u003Ef__switch\u0024map5 = new Dictionary<string, int>(2)
        {
          {
            "DISP",
            0
      ...
      int num;
      // ISSUE: reference to a compiler-generated field
      if (!BattleCameraControl.\u003C\u003Ef__switch\u0024map5.TryGetValue(key1, out num))
        return;
      switch (num)
      {
        case 0:
